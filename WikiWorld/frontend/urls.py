...
urlpatterns1 = [
    ...
    path('article_page_auth/<int:pk>/', views.article_page_auth, name='article_page_auth'),
    path('articles_topic_auth/<int:pk>/', views.articles_topic_auth, name='articles_topic_auth'),
